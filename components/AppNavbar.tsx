...
export default function AppNavbar({
  ...
  const handleViewProfile = async () => {
    try {
      ...
      // You can also just fetch in /profile page,
      // but for now we store it so the page can read it.
      ...
      alert(
        err?.message ||
          "No profile found. Please create your plan first so we can save your profile."
      );
    }
  };
            ...
            <>
              {!user ? (
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent
                    align="end"
                    className="min-w-[180px] bg-slate-900 border border-slate-700"
                  >
